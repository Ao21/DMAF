...
if($routeParams.person === 'majella'){
		...
		$scope.info = "<p>I am a maker. Specifically I am an object designer, jeweller and tutor. I combine precious and no-precious materials and see my work as a constant exploration and evaluation of what makes jewellery precious. Outside of my work in the Metalastics, Timber and (sometimes) Digital Fabrication Labs I teach a variety of courses relating to contemporary jewellery and objects. I regularly participate in exhibition and have work held in private collections.</p><p>My qualifications in both Training and Assessment (Cert IV) and Metal Fabrication & Engineering Production Systems (Cert III) have honed my teaching skills and are being utilized daily in the DMaF Labs. I teach into the Safety and Induction Unit (SICU), and assist students one on one with their fabrication projects.  I can advise on creating through the use of lathes, linishers, bandsaws, micro-motors, polishing motors, grinders, guillotines, drill press, soldering equipment, welding equipment, haudraulic press, magna bender and more.</p><p>Current inductions into laser cutting, CNC milling and 6-axis routing are furthering my interest in the cross pollination of analogue and digital equipment.</p>"
	}
